      ...
      <table className="w-full min-w-[900px] text-sm">
        <thead>
          ...
          <tr className="border-b border-gray-200 bg-white">
            ...
            <td className="px-3 py-1">
              <input
                className="w-full rounded border border-gray-200 px-2 py-0.5 text-xs focus:outline-none focus:ring-1 focus:ring-blue-400"
                placeholder=""
              />
            </td>
            <td className="px-3 py-1">
          ...
          {faturas.map((f, idx) => (
            ...
            >
              ...
              <td className="px-3 py-2.5 text-center">
                <PagamentoBadge
                  status={f.pagamentoStatus ?? "NAO_PROCESSADO"}
                />
              </td>
              <td className="px-3 py-2.5 text-center">
        ...
        <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-2 border-b border-gray-200 px-4 py-2.5">
            ...
            <div className="ml-auto flex items-center gap-1.5">
              ...
              <button type="button" className="flex h-7 items-center gap-1 rounded-full border border-gray-300 bg-white px-2.5 text-xs text-gray-600 hover:bg-gray-50">
                <svg
                  viewBox="0 0 20 20"
                  fill="none"
                  stroke="currentColor"
