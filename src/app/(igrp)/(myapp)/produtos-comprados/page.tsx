...
export default function ProdutosCompradosPage() {
  ...
  return (
    ...
    >
      ...
      <IGRPPageHeader
        name="produtos-comprados-header"
        tag="produtos-comprados-header"
        title="Produtos Comprados"
        description="Catálogo de produtos e serviços adquiridos de fornecedores"
        className="border-b px-6 py-3 bg-white"
      />

      <div className="p-5">
        <IGRPCard
          name="card-produtos-comprados"
          tag="card-produtos-comprados"
        ...
        >
          <IGRPCardContent className="p-5 space-y-4">
            ...
            {isLoading ? (
              ...
              <IGRPTable
                id="produtos-comprados-table"
                tag="table-produtos-comprados"
                content={produtos}
                columns={[
                  {
                    header: "Tipo",
