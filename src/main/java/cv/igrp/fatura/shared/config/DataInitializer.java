    ...
    private void seedClientes() {
        try {
            if (clienteRepository.count() > 0) {
                System.out.println("[SEEDER] clientes already present, skipping.");
                return;
            }
            ...
            System.out.println("[SEEDER] clientes saved OK");
        } catch (Exception e) {
            System.out.println("[SEEDER] ERROR saving clientes: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void seedFornecedores() {
        try {
            if (fornecedorRepository.count() > 0) {
                System.out.println("[SEEDER] fornecedores already present, skipping.");
                return;
            }
            ...
            System.out.println("[SEEDER] fornecedores saved OK");
        } catch (Exception e) {
            System.out.println("[SEEDER] ERROR saving fornecedores: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void seedProdutos() {
        try {
            if (produtoRepository.count() > 0) {
                System.out.println("[SEEDER] produtos already present, skipping.");
                return;
            }
            ...
            System.out.println("[SEEDER] produtos saved OK");
        } catch (Exception e) {
            System.out.println("[SEEDER] ERROR saving produtos: " + e.getMessage());
            e.printStackTrace();
        }
    }
}
