...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "fatura_compra_item_imposto")
public class FaturaCompraItemImpostoEntity extends AuditEntity {
    ...
    @JoinColumn(name = "fatura_compra_item_id", nullable = false)
    private FaturaCompraItemEntity faturaCompraItem;
