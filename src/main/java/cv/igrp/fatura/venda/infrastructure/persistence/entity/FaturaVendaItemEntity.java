...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "fatura_venda_item")
public class FaturaVendaItemEntity extends AuditEntity {
    ...
    @JoinColumn(name = "fatura_venda_id", nullable = false)
    private FaturaVendaEntity faturaVenda;
    ...
    @JsonIgnoreProperties("faturaVendaItem")
    @OneToMany(mappedBy = "faturaVendaItem", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<FaturaVendaItemImpostoEntity> impostos = new ArrayList<>();
}
